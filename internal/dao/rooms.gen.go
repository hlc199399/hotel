...
func newRoom(db *gorm.DB, opts ...gen.DOOption) room {
	...
	_room.No = field.NewUint(tableName, "no")
	_room.RoomType = field.NewUint(tableName, "room_type")
	_room.Status = field.NewUint(tableName, "status")
	_room.Price = field.NewFloat64(tableName, "price")
...
func (r *room) updateTableName(table string) *room {
	...
	r.RoomType = field.NewUint(table, "room_type")
...
func (r *room) fillFieldMap() {
	...
	r.fieldMap["no"] = r.No
	r.fieldMap["room_type"] = r.RoomType
