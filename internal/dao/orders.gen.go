...
func newOrder(db *gorm.DB, opts ...gen.DOOption) order {
	...
	_order.RoomID = field.NewUint(tableName, "room_id")
	_order.TotalFee = field.NewFloat64(tableName, "total_fee")
...
func (o *order) updateTableName(table string) *order {
	...
	o.RoomID = field.NewUint(table, "room_id")
	o.TotalFee = field.NewFloat64(table, "total_fee")
...
func (o *order) fillFieldMap() {
	...
	o.fieldMap["total_fee"] = o.TotalFee
}
